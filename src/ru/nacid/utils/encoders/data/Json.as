package ru.nacid.utils.encoders.data
{
	...
	{
		private var classDef:Object;
		
		public function Json(){
			classDef = by.blooddy.crypto.serialization.JSON;
		}
		...
		{
			return classDef.decode(String($data));
		}

		public function decodeString($data:Object):String
		{
			return String(classDef.decode(String($data)));
		}

		public function decodeFloat($data:Object):Number
		{
			return parseFloat(String(classDef.decode(String($data))));
		}
