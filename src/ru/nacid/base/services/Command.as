package ru.nacid.base.services
{
	...
	public class Command extends EventDispatcher implements ICommand
	{
		...
		public function terminate():void
		{
			...
			Cc.infoch(CMD_CHANNEL, id, 'terminated. Current cache size:', cache.length);
		}
